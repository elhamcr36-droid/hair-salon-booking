...
# --- ส่วนหน้า ADMIN ที่แก้ไขใหม่ ---
    ...
    with at2:
        # แสดงเฉพาะรายการคิว ไม่มีช่องกรอกเบอร์โทรค้าง
        if not df_b.empty:
    ...
    with at3:
        df_m = get_data("Messages")
        if not df_m.empty:
            # เลือกคุยกับลูกค้าโดยตรง ไม่ต้องกรอกเบอร์ admin
